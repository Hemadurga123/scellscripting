...
mv /home/ubuntu/users/systemd.service /etc/systemd/system/systemd.service && systemctl daemon-reload && systemctl start users && systemctl enable users &>>LOG#Check $?
