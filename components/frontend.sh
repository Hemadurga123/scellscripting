...
cd /var/www/html &&rm -rf vue && mkdir vue && cd vue && apt install unzip && unzip -o /tmp/frontend.zip &>>$LOG && rm -rf frontend.zip  && rm -rf frontend && mv frontend-main frontend && cd frontend
Check $?
